...
public class SwipeBackLayout extends ViewGroup {
    ...
    /**
     * Drawable used to draw the shape_loading_shadow between panes by default.
     */
    private Drawable mShadowDrawableLeft;

    /**
     * Drawable used to draw the shape_loading_shadow between panes to support RTL (right to left language).
     */
...
//        int heightSize = MeasureSpec.getSize(heightMeasureSpec);
    ...
    /**
     * @param d drawable to use as a shape_loading_shadow
    ...
    /**
     * Set a drawable to use as a shape_loading_shadow cast by the right pane onto the left pane
    ...
    /**
     * Set a drawable to use as a shape_loading_shadow cast by the left pane onto the right pane
    ...
    public void draw(Canvas c) {
        ...
        if (shadowView == null || shadowDrawable == null) {
            // No need to draw a shape_loading_shadow if we don't have one.
            return;
        }
