...
import com.flyang.base.view.shape.ShapeView;
...
public class ShapeLoadingView extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            mLoadText = typedArray.getString(R.styleable.ShapeLoadingView_shapeText);
            mColor = typedArray.getColor(R.styleable.ShapeLoadingView_shapeTextColor, Color.WHITE);
