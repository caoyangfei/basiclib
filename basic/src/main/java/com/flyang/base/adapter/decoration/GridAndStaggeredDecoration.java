...
/**
 * @author caoyangfei
 * @ClassName GridAndStaggeredDecoration
 * @date 2019/9/21
 * ------------- Description -------------
 * <p>
...
public class GridAndStaggeredDecoration extends RecyclerView.ItemDecoration {
     ...
     * 创建默认分割线
     */
    public static GridAndStaggeredDecoration createDefault(Context context) {
        return new GridAndStaggeredDecoration(context);
    }
     ...
     * @param color 色值
     */
    public static GridAndStaggeredDecoration createDefault(int color) {
        return new GridAndStaggeredDecoration(color);
    }
     ...
     * @param context 上下文
     */
    public GridAndStaggeredDecoration(Context context) {
     ...
     */
    public GridAndStaggeredDecoration(Context context, Drawable drawable) {
     ...
     */
    public GridAndStaggeredDecoration(Context context, @DrawableRes int drawableResId) {
     ...
     * @param color 色值
     */
    public GridAndStaggeredDecoration(@ColorInt int color) {
        this(color, 1, 1);
    }
     ...
     */
    public GridAndStaggeredDecoration(@ColorInt int color, int width, int height) {
