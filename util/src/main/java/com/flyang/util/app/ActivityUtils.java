...
public final class ActivityUtils {
    ...
    public static boolean isActivityExists(@NonNull final String pkg,
        ...
        return !(ApplicationUtils.getApp().getPackageManager().resolveActivity(intent, 0) == null ||
                intent.resolveActivity(ApplicationUtils.getApp().getPackageManager()) == null ||
                ApplicationUtils.getApp().getPackageManager().queryIntentActivities(intent, 0).size() == 0);
    }
    ...
    public static void startActivity(@NonNull final Class<? extends Activity> clz) {
        Context context = ApplicationUtils.getTopActivityOrApp();
    ...
    public static void startActivity(@NonNull final String pkg,
                                     @NonNull final String cls) {
        startActivity(ApplicationUtils.getTopActivityOrApp(), null, pkg, cls, null);
    }
    ...
    public static void startActivity(@NonNull final String pkg,
                                     @NonNull final String cls,
                                     final Bundle options) {
        startActivity(ApplicationUtils.getTopActivityOrApp(), null, pkg, cls, options);
    }
    ...
    public static void startActivity(@NonNull final Bundle extras,
                                     @NonNull final String pkg,
                                     @NonNull final String cls) {
        startActivity(ApplicationUtils.getTopActivityOrApp(), extras, pkg, cls, null);
    }
    ...
    public static void startActivity(@NonNull final Bundle extras,
                                     ...
                                     @NonNull final String cls,
                                     final Bundle options) {
        startActivity(ApplicationUtils.getTopActivityOrApp(), extras, pkg, cls, options);
    }
    ...
    public static boolean startActivity(@NonNull final Intent intent) {
        return startActivity(intent, ApplicationUtils.getTopActivityOrApp(), null);
    }
    ...
    public static boolean startActivity(@NonNull final Intent intent,
                                        @NonNull final Bundle options) {
        return startActivity(intent, ApplicationUtils.getTopActivityOrApp(), options);
    }
    ...
    public static void startActivities(@NonNull final Intent[] intents) {
        startActivities(intents, ApplicationUtils.getTopActivityOrApp(), null);
    }
    ...
    public static void startActivities(@NonNull final Intent[] intents,
                                       final Bundle options) {
        startActivities(intents, ApplicationUtils.getTopActivityOrApp(), options);
    }
    ...
    public static List<Activity> getActivityList() {
        return ApplicationUtils.getActivityList();
    }
    ...
    public static String getLauncherActivity() {
        return getLauncherActivity(ApplicationUtils.getApp().getPackageName());
    }
    ...
    public static boolean isActivityExistsInStack(@NonNull final Activity activity) {
        List<Activity> activities = ApplicationUtils.getActivityList();
    ...
    /**
     * 结束activity,如果activity 不存在返回false
     *
     * @param activity      The activity.
     * @param isIncludeSelf True to include the activity, false otherwise.
     * @param enterAnim     {@code true}<br>{@code false}:进入动画
     * @param exitAnim      {@code true}<br>{@code false}: 退出动画
     */
     ...
     * 结束所有activity
     *
     * @param isLoadAnim {@code true}<br>{@code false}:启用动画
     */
    public static void finishAllActivities(final boolean isLoadAnim) {
        List<Activity> activityList = ApplicationUtils.getActivityList();
    ...
    public static Drawable getActivityIcon(@NonNull final Class<? extends Activity> clz) {
        return getActivityIcon(new ComponentName(ApplicationUtils.getApp(), clz));
    }
    ...
    public static Drawable getActivityLogo(@NonNull final Class<? extends Activity> clz) {
        return getActivityLogo(new ComponentName(ApplicationUtils.getApp(), clz));
    }
