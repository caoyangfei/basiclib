...
import com.flyang.util.bean.Gregorian;
import com.flyang.util.bean.Lunar;
...
public final class CalendarUtils {
     ...
     * @return 公历
     */
    public static Gregorian lunar2Solar(final Lunar lunar) {
        ...
        int gregor11 = SOLAR_1_1[lunar.lunarYear - SOLAR_1_1[0]];

        int y = getBitInt(gregor11, 12, 9);
        int m = getBitInt(gregor11, 4, 5);
        int d = getBitInt(gregor11, 5, 0);

        return gregorFromInt(gregorToInt(y, m, d) + offset - 1);
    }
     ...
     * @return 阴历
     */
    public static Lunar gregor2Lunar(final Gregorian gregor) {
        Lunar lunar = new Lunar();
        int index = gregor.gregorYear - SOLAR_1_1[0];
        int data = (gregor.gregorYear << 9) | (gregor.gregorMonth << 5) | (gregor.gregorDay);
        int gregor11 = 0;
        if (SOLAR_1_1[index] > data) {
            index--;
        }
        gregor11 = SOLAR_1_1[index];
        int y = getBitInt(gregor11, 12, 9);
        int m = getBitInt(gregor11, 4, 5);
        int d = getBitInt(gregor11, 5, 0);
        long offset = gregorToInt(gregor.gregorYear, gregor.gregorMonth, gregor.gregorDay) - gregorToInt(y, m, d);
    ...
    private static Gregorian gregorFromInt(final long g) {
        ...
        Gregorian gregor = new Gregorian();
        gregor.gregorYear = (int) y;
        gregor.gregorMonth = (int) mm;
        gregor.gregorDay = (int) dd;
        return gregor;
    }

    private static long gregorToInt(int y, int m, final int d) {
        m = (m + 9) % 12;
        y = y - m / 10;
