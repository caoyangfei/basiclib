...
public class ReflectUtils {
     ...
     * @see #on(Class)
     */
    public static ReflectUtils on(String name, ClassLoader classLoader) throws RuntimeException {
     ...
     */
    public ReflectUtils set(Field field, Object value) throws RuntimeException {
        try {
    ...
    private static ReflectUtils on(Constructor<?> constructor, Object... args) throws RuntimeException {
        try {
    ...
    private static ReflectUtils on(Method method, Object object, Object... args) throws RuntimeException {
        try {
            accessible(method);
